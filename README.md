...
My homelab kubernetes cluster has one master node and three worker nodes.
It is used to test deployments, run microservices, and experiment with infrastructure configurations in a controlled environment.
